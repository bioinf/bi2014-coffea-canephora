...
png('tree.png', width=480, height=320)
plot(tr)
text(x=4, y=3.05, labels="4343 / 15160 / 28504", cex=.8)
text(x=4, y=1.94, labels="3467 / 33023 / 11517", cex=.8)
text(x=1.8, y=2.55, labels="407 / 32766 / 14834", cex=.8)
text(x=1.8, y=1.05, labels="1245 / 28726 / 18036", cex=.8)
dev.off()
